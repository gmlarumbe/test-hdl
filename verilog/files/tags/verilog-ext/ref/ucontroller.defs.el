#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data
		...
		:locs
		((:type "module" :desc "module ucontroller # (" :file "verilog/files/common/ucontroller.sv" :line 21 :col 18)))
	       "FREQ_CLK"
	       (:items nil :locs
		       ((:type "parameter logic [31:0]" :desc "parameter logic [31:0] FREQ_CLK = 100000000," :file "verilog/files/common/ucontroller.sv" :line 22 :col 27)))
	       "TX_SPEED"
	       (:items nil :locs
		       ((:type "parameter logic [31:0]" :desc "parameter logic [31:0] TX_SPEED = 115200" :file "verilog/files/common/ucontroller.sv" :line 23 :col 27)))
	       "Clk"
	       (:items nil :locs
		       ((:type "input logic" :desc "input logic         Clk," :file "verilog/files/common/ucontroller.sv" :line 25 :col 24)))
	       "Rst_n"
	       (:items nil :locs
		       ((:type "input logic" :desc "input logic         Rst_n," :file "verilog/files/common/ucontroller.sv" :line 26 :col 24)))
	       "RXD"
	       (:items nil :locs
		       ((:type "input logic" :desc "input logic         RXD," :file "verilog/files/common/ucontroller.sv" :line 28 :col 24)))
	       "TXD"
	       (:items nil :locs
		       ((:type "output logic" :desc "output logic        TXD," :file "verilog/files/common/ucontroller.sv" :line 29 :col 24)))
	       "ROM_Data"
	       (:items nil :locs
		       ((:type "input logic [11:0]" :desc "input logic [11:0]  ROM_Data," :file "verilog/files/common/ucontroller.sv" :line 31 :col 24)))
	       "ROM_Addr"
	       (:items nil :locs
		       ((:type "output logic [11:0]" :desc "output logic [11:0] ROM_Addr," :file "verilog/files/common/ucontroller.sv" :line 32 :col 24)))
	       "Temp"
	       (:items nil :locs
		       ((:type "output logic [7:0]" :desc "output logic [7:0]  Temp," :file "verilog/files/common/ucontroller.sv" :line 34 :col 24)))
	       "Switches"
	       (:items nil :locs
		       ((:type "output logic [7:0]" :desc "output logic [7:0]  Switches" :file "verilog/files/common/ucontroller.sv" :line 35 :col 24)))
	       "DMA_Oen"
	       (:items nil :locs
