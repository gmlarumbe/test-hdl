#s(hash-table test equal data
	      (("global_pkg" :file "verilog/files/common/tb_program.sv" :line 21)
	       ...
	       ("$dumpfile" :file "verilog/files/common/tb_program.sv" :line 48)
	       (:desc "        $dumpfile(\"tb_top.lx2\");  // iverilog, vpp & gtkwave" :col 8)
	       ("$dumpvars" :file "verilog/files/common/tb_program.sv" :line 49)
	       ...
	       ("$timeformat" :file "verilog/files/common/tb_program.sv" :line 50)
	       ...
	       ("$display" :file "verilog/files/common/tb_program.sv" :line 59)
	       (:desc "        $display(\"@%0d: Initializing ROM\", $time);" :col 8)
	       ("$time" :file "verilog/files/common/tb_program.sv" :line 59)
	       ...
	       (:desc "        repeat (BIT_CYCLES) @(posedge Clk);" :col 38)
	       ("$display" :file "verilog/files/common/tb_program.sv" :line 129)
	       (:desc "        $display(\"@%0d: End of Serial RX\", $time);" :col 8)
	       ("$time" :file "verilog/files/common/tb_program.sv" :line 129)
	       ...
	       ("$display" :file "verilog/files/common/tb_program.sv" :line 137)
	       ...
	       ("$display" :file "verilog/files/common/tb_program.sv" :line 146)
	       (:desc "        $display(\"@%0d: Timeout occurred\", $time);" :col 8)
	       ("$time" :file "verilog/files/common/tb_program.sv" :line 146)
